...
function updatePrice(){
    // Use querySelectorAll para selecionar todos os elementos com a classe '.quantity' e '.unit-price'
    let quantity = document.querySelectorAll('.quantity')[0].value;
    let unitPrice = document.querySelectorAll('.unit-price')[0].innerText;

    // Verifique se quantity e unitPrice são valores numéricos
    if (!isNaN(quantity) && !isNaN(unitPrice)) {
        ...
        console.error('Quantidade ou preço unitário não é um número válido.');
    }
}

// Use querySelectorAll para adicionar o evento de mudança a todos os elementos com a classe '.quantity'
